"""
Tendon Test - Material 1: Active 0deg
5x5x5 cube, all voxels Active 0deg (green)
Expected: Strong uniform breathing/pulsing at 10Hz
"""
import numpy as np
import mujoco
...
print("=" * 70)
print("TENDON TEST - Material 1: Active 0deg (Green)")
print("=" * 70)
print("\n5x5x5 cube - ALL voxels Active 0deg")
print("All tendons oscillate IN PHASE at 10Hz")
...
for x in range(2, 7):
    for y in range(2, 7):
        for z in range(2, 7):
            voxel_grid[x, y, z] = 1  # Active 0deg
...
print("\n" + "=" * 70)
print("TENDON MATERIAL 1 RESULTS: Active 0deg")
print("=" * 70)
if len(sizes) > 1:
    variation = (max(sizes) - min(sizes)) / np.mean(sizes) * 100
