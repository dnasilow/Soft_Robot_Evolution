"""
Test Material 2: Active 180° - Pure 5x5x5 cube
All voxels oscillate IN PHASE (but opposite to Material 1) at 10Hz
"""
import numpy as np
import mujoco
...
print("="*70)
print("MATERIAL 2 TEST: Active 180° (Red)")
print("="*70)
print("\n5x5x5 cube - ALL voxels are Active 180°")
print("All springs oscillate IN PHASE at 10Hz (opposite phase to Material 1)")
print("Expected: Strong uniform breathing/pulsing")
print("="*70)

# Create 5x5x5 cube - ALL Active 180°
voxel_grid = np.zeros((8, 8, 8), dtype=np.int8)
for x in range(2, 7):
    for y in range(2, 7):
        for z in range(2, 7):
            voxel_grid[x, y, z] = 2  # All Active 180° (red)
...
print("Watch for breathing motion!\n")
...
print("\n" + "="*70)
print("MATERIAL 2 RESULTS: Active 180°")
print("="*70)
if len(sizes) > 1:
    variation = (max(sizes) - min(sizes)) / np.mean(sizes) * 100
