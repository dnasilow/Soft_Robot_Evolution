"""
Test Material 1: Active 0° - Pure 5x5x5 cube
All voxels oscillate IN PHASE at 10Hz
"""
import numpy as np
import mujoco
...
print("="*70)
print("MATERIAL 1 TEST: Active 0° (Green)")
print("="*70)
print("\n5x5x5 cube - ALL voxels are Active 0°")
print("All springs oscillate IN PHASE at 10Hz")
print("Expected: Strong uniform breathing/pulsing")
print("="*70)

# Create 5x5x5 cube - ALL Active 0°
...
print("\n" + "="*70)
print("MATERIAL 1 RESULTS: Active 0°")
print("="*70)
if len(sizes) > 1:
    variation = (max(sizes) - min(sizes)) / np.mean(sizes) * 100
